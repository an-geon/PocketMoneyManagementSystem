...
import pocketmoney.Addkind;
import pocketmoney.Income;
import pocketmoney.Outlay;
import pocketmoney.Pocketmoney;

public class PocketmoneyManager implements Serializable{
	/**
	 * 
	 */
	...
	public void editPocketmoney() {
		...
		if (num == 1) {
			...
			pocketmoney.setBalance(pocketmoney1.get(index-1).getBalance() + pocketmoney.getPrice());
			resetBalance(pocketmoney1);
		}
	}
	
	public int size() {
		return pocketmoney1.size();
	}
	
	public Pocketmoney get(int index) {
		return pocketmoney1.get(index);
	}
	...
	public void viewList() {
		...
		for(int i = 0; i < pocketmoney1.size(); i++)
			System.out.println(pocketmoney1.get(i).getDate() + "\t"+pocketmoney1.get(i).getContent() + "\t"
				                       +pocketmoney1.get(i).getPrice() +"\t"+ pocketmoney1.get(i).getBalance());
	}
}
